...
const BLOG = {
  ...
  THEME: process.env.NEXT_PUBLIC_THEME || 'opc', // 当前主题
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Klarraum', // 您的昵称
  BIO: process.env.NEXT_PUBLIC_BIO || 'Psychologische Bildung für ein klareres Leben.', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://qizhang.vercel.app', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Psychologie, psychologische Bildung, Deutschland, Beziehungen, persönliches Wachstum', // 网站关键词
